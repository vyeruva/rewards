...
public class CustomerRepositoryTest {
  ...
  @Test
  public void filterDataOlderThanThreeMonths() {
    ...
    transactionBeforeThreeMonths.setDate(new GregorianCalendar(2022,5,1));
    ...
    transactionWithinThreeMonths.setDate(new GregorianCalendar(2022,10,8));
  ...
  public void filtersDataOlderThanThreeMonthsForAllCustomers() {
    Customer customerArthemis = new Customer();
    customerArthemis.setId(1);
    customerArthemis.setName("Artemis");
    customerArthemis.setUuid("123e4567-e89b-12d3-a456-426655440000");
    ...
    customerArthemis.getTransactions().add(transactionBeforeThreeMonths);
    ...
    customerArthemis.getTransactions().add(transactionWithinThreeMonths);

    customerRepository.save(customerArthemis);
    ...
    transactionBeforeThreeMonthsForAres.setDate(new GregorianCalendar(2022,5,1));
    ...
    transactionWithinThreeMonthsForAres.setDate(new GregorianCalendar(2022,10,8));
